...
">
    <nut-animate type="ripple" action="click">
      <view @click="showMenu=!showMenu"
            style='background-image: url("//pic.sherry.games/assets/image/aa.png");background-size: cover;vertical-align: middle;display: inline-block;width: 46px ;height: 46px;border-radius: 50%; '>
