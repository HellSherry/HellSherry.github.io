...
// 行政-----------------------------------------------------------------------------------------------------
        ...
        ,
        {
            ...
            children: [{
                ...
                {path: "topic", name: 'topic',  component: () => import('../components/practice/TopicList.vue')},
                {path: "question", name: 'question',  component: () => import('../components/practice/VueQuestion.vue')},
                {path: "history", name: 'history',  component: () => import('../components/practice/LookHistory.vue')},
                {path: "vueHistory", name: 'vueHistory',  component: () => import('../components/practice/PracticeHome.vue')},
