...
width: 100px;
        ...
        <img height="28"
             ...
             src="//pic.sherry.games/assets/汉字创科.png" alt="logo"/>
      </div>
    </div>
  ...
  <div style="background-image: url('//pic.sherry.games/assets/image/back.jpg');height: 100vh;">
...
<!--{{askList}}-->
            <t-list :scroll="{ type: 'virtual' }" size="large" style="margin-top: -4px;max-height: 80vh" :split="true">
              <t-list-item @click="toDetail(item)"  v-for="item in askList">
                ...
                <template #action>
<t-button @click.stop="" block variant="outline" shape="round"   style="margin-right: 40px">
  ...
  立即下载
        ...
        <t-aside :style="`background-image: linear-gradient(to bottom, #0000, #${store.darkT?'000000C9':'ffffffC9'} )`"
          ...
          <div @click="$router.push('/ai')"
               style="cursor: pointer;margin-top: 20px;height: 100px;background-image: url('//pic.sherry.games/assets/image/c-aside-codegpt.jpg');background-repeat: no-repeat;background-size: cover;background-position: center  ;border-radius: 12px"></div>
